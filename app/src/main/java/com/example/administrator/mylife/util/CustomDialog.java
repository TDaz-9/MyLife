...
public class CustomDialog extends Dialog{
    ...
    public static final class Builder {
        ...
        // 设置title值
        public Builder setTitle(int resView, String title) {
            TextView textView = (TextView) view.findViewById(resView);
            textView.setText(title);
            return this;
        }
        // 设置对话框的值（message）
        public Builder setMessage(int resView, String message) {
            TextView textView = (TextView) view.findViewById(resView);
