package com.example.administrator.mylife.http.okhttp.request;

import android.util.Pair;
import android.widget.ImageView;

import com.example.administrator.mylife.http.okhttp.OkHttpClientManager;
...
{
    protected static OkHttpClientManager mOkHttpClientManager = OkHttpClientManager.getInstance();
